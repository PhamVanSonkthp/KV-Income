        ...
        <div class="content-main__header">
            ...
            <div class="form-group__layout">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" value="{{ $item->phone }}" class="form-control input__field" placeholder="Enter Phone">
                </div>
                <div class="form-group">
                    ...
                    <select name="admin_groups[]" class="js-example-basic-multiple" multiple>
                        @foreach($roles as $role)
                            <option value="{{ $role->id }}" {{ in_array($role->id, $arr_role) ? 'selected' : ''  }}>{{ $role->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    @foreach($branchs as $branch)
                        <div class="branch__item">
                            <input type="checkbox" value="{{ $branch->id }}" {{ in_array($branch->id, $arr_branch) ? 'checked' : ''  }} name="branch" id="branch{{ $branch->id }}">
