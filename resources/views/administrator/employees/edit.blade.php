        ...
        <div class="content-main__header">
            ...
            <div class="form-group__layout">
                <div class="form-group">
                    ...
                    <input type="text" id="id" name="id" class="form-control input__field" placeholder="Enter ID" value="{{ $item->id }}">
                </div>
                <div class="form-group">
                    <label for="code" class="fw-bold">Code</label>
                    <input type="text" id="code" name="code" class="form-control input__field" placeholder="Enter code" value="{{ $item->code }}">
                </div>
                <div class="form-group">
                    <label for="name" class="fw-bold">Name</label>
                    <input type="text" id="name" name="name" class="form-control input__field" placeholder="Enter admin user" value="{{ $item->name }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control input__field" placeholder="Enter phone number" value="{{ $item->phone }}">
                </div>
                <div class="form-group">
                    <label for="start" class="fw-bold">Start date</label>
                    <input type="text" id="start" data-language="en" name="start" value="{{ \App\Models\Helper::convert_date_from_db2($item->start) }}" class="datepicker-here form-control input__field" placeholder="Enter date">
                    <span class="icon">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="birthday" data-language="en" value="{{ \App\Models\Helper::convert_date_from_db2($item->date_of_birth) }}" name="birthday" class="datepicker-here form-control input__field" placeholder="Enter date">
                    <span class="icon">
                         <i class="fa-regular fa-calendar"></i>
                    </span>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" id="address" name="address" class="form-control input__field" placeholder="Enter address" value="{{ $item->address }}">
                </div>
                <div class="form-group">
        ...
        function update{{ $prefixView }}(id) {
            callAjax(
                ...
                '{{ route('administrator.'.$prefixView.'.update') }}?id='+id,
                {
                    ...
                    'avatar' : $('#single-image-preview > li > img').attr('src'),
                    'is_admin' : 0,
                },
                (response) => {
